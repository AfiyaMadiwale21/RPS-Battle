...
✅ Interactive UI with Game Result Display  
...
- **CSS3** – For styling and enhancing the look.  
...
- Open the \`index.html\` file in any modern browser (Chrome/Firefox).

---

## 📧 Contact
For suggestions or queries:  
💌 **Email:** [afiyamadiwale@gmail.com]  
